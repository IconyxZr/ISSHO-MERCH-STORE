...
<div class="container-table-cart pos-relative">
    ...
    ?>
        ...
        <table class="table-shopping-cart" width="600px">
            <tr class="table-head">
                <th class="column-1">GAMBAR</th>
                <th class="column-2">Product</th>
                <th class="column-3" style="width:15%">HARGA</th>
            ...
            <tr class="table-row">
                ...
                <td class="column-5">Rp. <?php $sub_total = $keranjang['price'] * $keranjang['qty']; echo number_format($sub_total,'0',',','.');?>
                </td>
                <td class="column-6">
        ...
        <p class="pull-right">
            ...
            <a href="<?php echo base_url('belanja/checkout') ?>" class="btn btn-success btn-lg">
                <i class="fa fa-shoppong-cart"></i> Checkout
            </a>
        </p>
    </div>
</div>
