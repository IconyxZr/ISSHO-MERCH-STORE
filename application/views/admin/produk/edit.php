...
<div class="form-group">
    <label class="col-sm-2 control-label">Berat Produk</label>
        <div class="col-sm-5">
...
<div class="form-group">
    <label class="col-sm-2 control-label">Ukuran Produk</label>
        <div class="col-sm-5">
...
<div class="form-group">
    <label class="col-sm-2 control-label">Keyword (untuk SEO Google)</label>
        <div class="col-sm-10">
...
<div class="form-group">
    ...
    <option value="Draft"<?php if($produk->status_produk=="Draft") {echo "selected";} ?>>Simpan Seabagai Draft</option>
    </select>
    </div>
</div>
