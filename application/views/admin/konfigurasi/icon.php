...
<div class="form-group"> 
   <label class="col-sm-3 control-label">Upload Logo Baru</label>
        <div class="col-sm-8">
    <input type="file" name="icon" class="form-control" placeholder="Upload Logo" value="<?php echo $konfigurasi->icon ?>" required>
    </div>
</div>

<div class="form-group"> 
   <label class="col-sm-3 control-label">Logo Lama</label>
        <div class="col-sm-8">
